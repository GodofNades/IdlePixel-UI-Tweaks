...
(function () {
	...
	const IMAGE_URL_BASE = copperItemBox
		.getAttribute("src")
		.replace(/\/[^/]+.png$/, "");
	...
	class UITweaksPlugin extends IdlePixelPlusPlugin {
		...
		condensedUI() {
			...
			setTimeout(function () {
				document.getElementById("market-sidecar").parentNode.parentNode.style =
					"padding-left: 20px";
			}, 1000);
		...
		hideOrbsAndRing() {
			if (Globals.currentPanel === "panel-invention") {
				const masterRing = IdlePixelPlus.getVarOrDefault(
					"master_ring_assembled",
					0,
					"int"
				);
				const fishingOrb = IdlePixelPlus.getVarOrDefault(
					"mega_shiny_glass_ball_fish_assembled",
					0,
					"int"
				);
				const leafOrb = IdlePixelPlus.getVarOrDefault(
					"mega_shiny_glass_ball_leaf_assembled",
					0,
					"int"
				);
				const logsOrb = IdlePixelPlus.getVarOrDefault(
					"mega_shiny_glass_ball_logs_assembled",
					0,
					"int"
				);
				const monstersOrb = IdlePixelPlus.getVarOrDefault(
					"mega_shiny_glass_ball_monsters_assembled",
					0,
					"int"
				);
				const volcanoTab = IdlePixelPlus.getVarOrDefault(
					"volcano_tablette_charged",
					0,
					"int"
				);
				const ancientTab = IdlePixelPlus.getVarOrDefault(
					"ancient_tablette_charged",
					0,
					"int"
				);
				...
				const uiTweaksConfig =
					IdlePixelPlus.plugins["ui-tweaks"].getConfig("hideOrbRing");
		...
		miningMachTimer() {
			...
			if (drillNotifications) {
				...
				document.getElementById("notification-giant_drill").style.display =
					"none";
				document.getElementById("notification-excavator").style.display =
					"none";
				document.getElementById("notification-giant_excavator").style.display =
					"none";
				document.getElementById(
					"notification-massive_excavator"
				).style.display = "none";
			} else {
				const drill = IdlePixelPlus.getVarOrDefault("drill_on", 0, "int");
				const crusher = IdlePixelPlus.getVarOrDefault("crusher_on", 0, "int");
				const giant_drill = IdlePixelPlus.getVarOrDefault(
					"giant_drill_on",
					0,
					"int"
				);
				const excavator = IdlePixelPlus.getVarOrDefault(
					"excavator_on",
					0,
					"int"
				);
				const giant_excavator = IdlePixelPlus.getVarOrDefault(
					"giant_excavator_on",
					0,
					"int"
				);
				const massive_excavator = IdlePixelPlus.getVarOrDefault(
					"massive_excavator_on",
					0,
					"int"
				);

				if (drill > 0) {
					document.getElementById("notification-drill").style.display =
						"inline-block";
				}
				if (crusher > 0) {
					document.getElementById("notification-crusher").style.display =
						"inline-block";
				}
				if (giant_drill > 0) {
					document.getElementById("notification-giant_drill").style.display =
		...
		oilTimerNotification() {
			...
			elem.setAttribute(
				"src",
				"https://d1xsc8x7nc5q8t.cloudfront.net/images/oil.png"
			);
		...
		loot_pot_avail() {
			...
			elem.setAttribute(
				"src",
				"https://d1xsc8x7nc5q8t.cloudfront.net/images/combat_loot_potion.png"
			);
			const notifIcon = elem;
			notifIcon.className = "w20";
		...
		extendedLevelsUpdate() {
			...
			const xpGathering = IdlePixelPlus.getVarOrDefault(
				"gathering_xp",
				0,
				"int"
			);
			...
			const xpWoodcutting = IdlePixelPlus.getVarOrDefault(
				"woodcutting_xp",
				0,
				"int"
			);
			const extendedLevelWoodcutting =
				this.calculateExtendedLevel(xpWoodcutting);
			...
			const xpInvention = IdlePixelPlus.getVarOrDefault(
				"invention_xp",
				0,
				"int"
			);
			...
			overallLevel =
				extendedLevelMining +
				extendedLevelCrafting +
				extendedLevelGathering +
				extendedLevelFarming +
				extendedLevelBrewing +
				extendedLevelWoodcutting +
				extendedLevelCooking +
				extendedLevelFishing +
				extendedLevelInvention +
				extendedLevelMelee +
				extendedLevelArchery +
				extendedLevelMagic;
		...
		fightPointsFull() {
			...
			if (remaining === 0) {
				...
				var masterRingEquip = IdlePixelPlus.getVarOrDefault(
					"master_ring_equipped",
					0,
					"int"
				);
		...
		updateColors(filter) {
			...
			if (!bgColorCheck) {
				...
				const chatBorderOverrideColorEnabled = this.getConfig(
					"chatBorderOverrideColorEnabled"
				);
				const chatBorderOverrideColor = this.getConfig(
		...
		onConfigsChanged() {
			if (onLoginLoaded) {
				...
				//////
				const condenseWoodcuttingPatches = this.getConfig(
				...
				const smeltingNotificationTimer = this.getConfig(
				...
				const mixerAvail = IdlePixelPlus.getVarOrDefault(
					"brewing_xp_mixer_crafted"
				);
				...
				const sdWatchUnlocked = IdlePixelPlus.getVarOrDefault(
					"stardust_watch_crafted",
					0,
					"int"
				);
				...
				const purpleKeyUnlock = IdlePixelPlus.getVarOrDefault(
					"guardian_purple_key_hint",
					0,
					"int"
				);
				...
				const pirate_ship_timer = IdlePixelPlus.getVarOrDefault(
					"pirate_ship_timer",
					0,
					"int"
				);
				const row_boat_timer = IdlePixelPlus.getVarOrDefault(
					"row_boat_timer",
					0,
					"int"
				);
				const canoe_boat_timer = IdlePixelPlus.getVarOrDefault(
					"canoe_boat_timer",
					0,
					"int"
				);
				const stardust_boat_timer = IdlePixelPlus.getVarOrDefault(
					"stardust_boat_timer",
					0,
					"int"
				);
				...
				const rocket_check = IdlePixelPlus.getVarOrDefault(
					"mega_rocket",
					0,
					"int"
				);
				...
				setTimeout(function () {
					if (document.getElementById("notification-furnace_avail")) {
						const furnaceOreTypeVar = IdlePixelPlus.getVarOrDefault(
		...
		onLogin() {
			...
			addLoadingSpanAfterElement(
				"#menu-bar-mining-level",
				"overallLevelExtended-mining"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-crafting-level",
				"overallLevelExtended-crafting"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-gathering-level",
				"overallLevelExtended-gathering"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-farming-level",
				"overallLevelExtended-farming"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-brewing-level",
				"overallLevelExtended-brewing"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-woodcutting-level",
				"overallLevelExtended-woodcutting"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-cooking-level",
				"overallLevelExtended-cooking"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-fishing-level",
				"overallLevelExtended-fishing"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-invention-level",
				"overallLevelExtended-invention"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-melee-level",
				"overallLevelExtended-melee"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-archery-level",
				"overallLevelExtended-archery"
			);
			addLoadingSpanAfterElement(
				"#menu-bar-magic-level",
				"overallLevelExtended-magic"
			);

			this.updateColors();

			var loot_pot = IdlePixelPlus.getVarOrDefault(
				"combat_loot_potion_active",
				0,
				"int"
			);
			var merchantTiming = IdlePixelPlus.getVarOrDefault(
				"merchant_timer",
				0,
				"int"
			);
			var merchantUnlocked = IdlePixelPlus.getVarOrDefault(
				"merchant",
				0,
				"int"
			);
			let robotTiming = IdlePixelPlus.getVarOrDefault(
				"robot_wave_timer",
				0,
				"int"
			);
			var robotUnlocked = IdlePixelPlus.getVarOrDefault(
				"robot_crafted",
				0,
				"int"
			);
			...
			const addBrewerNotifications = (timer, charges) => {
				var mixerUnlocked = IdlePixelPlus.getVarOrDefault(
					"brewing_xp_mixer_crafted"
				);
				const notifDiv = document.createElement("div");
				...
				elem.setAttribute(
					"src",
					"https://d1xsc8x7nc5q8t.cloudfront.net/images/brewing_xp_mixer.png"
				);
				const notifIcon = elem;
				notifIcon.className = "w20";
			...
			const brewingTimer = () => {
				...
				if (mixerUnlocked == 1) {
					...
					let chargesUsed = IdlePixelPlus.getVarOrDefault(
						"brewing_xp_mixer_used",
						0,
						"int"
					);
					...
					const runBrewingTimer = setInterval(function () {
						...
						chargesUsed = IdlePixelPlus.getVarOrDefault(
							"brewing_xp_mixer_used",
							0,
							"int"
						);
			...
			const addMerchantNotifications = () => {
				var merchantTimerCheck = IdlePixelPlus.getVarOrDefault(
					"merchant_timer",
					0,
					"int"
				);
				...
				elem.setAttribute(
					"src",
					"https://d1xsc8x7nc5q8t.cloudfront.net/images/merchant.png"
				);
				const notifIcon = elem;
				notifIcon.className = "w20";
			...
			const merchantTimer = () => {
				...
				if (merchantUnlocked == 1) {
					let merchantTiming = IdlePixelPlus.getVarOrDefault(
						"merchant_timer",
						0,
						"int"
					);
					...
					const runMerchantTimer = setInterval(function () {
						merchantTiming = IdlePixelPlus.getVarOrDefault(
							"merchant_timer",
							0,
							"int"
						);
			...
			const addFurnaceNotification = () => {
				if (
					IdlePixelPlus.getVarOrDefault("stone_furnace_crafted", 0, "int") == 1
				) {
					var furnaceOreType = IdlePixelPlus.getVarOrDefault(
						"furnace_ore_type",
						"none",
						"string"
					);
					var dragFur = IdlePixelPlus.getVarOrDefault(
						"dragon_furnace",
						0,
						"int"
					);
					var ancFur = IdlePixelPlus.getVarOrDefault(
						"ancient_furnace_crafted",
						0,
						"int"
					);
					var titFur = IdlePixelPlus.getVarOrDefault(
						"titanium_furnace_crafted",
						0,
						"int"
					);
					var promFur = IdlePixelPlus.getVarOrDefault(
						"promethium_furnace_crafted",
						0,
						"int"
					);
					var goldFur = IdlePixelPlus.getVarOrDefault(
						"gold_furnace_crafted",
						0,
						"int"
					);
					var silvFur = IdlePixelPlus.getVarOrDefault(
						"silver_furnace_crafted",
						0,
						"int"
					);
					var ironFur = IdlePixelPlus.getVarOrDefault(
						"iron_furnace_crafted",
						0,
						"int"
					);
					var bronzeFur = IdlePixelPlus.getVarOrDefault(
						"bronze_furnace_crafted",
						0,
						"int"
					);
					var stoneFur = IdlePixelPlus.getVarOrDefault(
					...
					if (dragFur == 1) {
						furnImg =
							"https://d1xsc8x7nc5q8t.cloudfront.net/images/dragon_furnace.png";
					} else if (ancFur == 1) {
						furnImg =
							"https://d1xsc8x7nc5q8t.cloudfront.net/images/ancient_furnace.png";
					} else if (titFur == 1) {
						furnImg =
							"https://d1xsc8x7nc5q8t.cloudfront.net/images/titanium_furnace.png";
					} else if (promFur == 1) {
						furnImg =
							"https://d1xsc8x7nc5q8t.cloudfront.net/images/promethium_furnace.png";
					} else if (goldFur == 1) {
						furnImg =
							"https://d1xsc8x7nc5q8t.cloudfront.net/images/gold_furnace.png";
					} else if (silvFur == 1) {
						furnImg =
							"https://d1xsc8x7nc5q8t.cloudfront.net/images/silver_furnace.png";
					} else if (ironFur == 1) {
						furnImg =
							"https://d1xsc8x7nc5q8t.cloudfront.net/images/iron_furnace.png";
					} else if (bronzeFur == 1) {
						furnImg =
							"https://d1xsc8x7nc5q8t.cloudfront.net/images/bronze_furnace.png";
					} else if (stoneFur == 1) {
						furnImg =
							"https://d1xsc8x7nc5q8t.cloudfront.net/images/stone_furnace.png";
					} else {
						document.querySelector(
							"#notification-furnace_avail"
						).style.display = "none";
			...
			const addRobotNotifications = () => {
				var robotTimerCheck = IdlePixelPlus.getVarOrDefault(
					"robot_wave_timer",
					0,
					"int"
				);
				...
				elem.setAttribute(
					"src",
					"https://d1xsc8x7nc5q8t.cloudfront.net/images/robot.png"
				);
				const notifIcon = elem;
				notifIcon.className = "w20";
			...
			const robotTimer = () => {
				...
				if (robotUnlocked == 1) {
					...
					const runRobotTimer = setInterval(function () {
						...
						robotTiming = IdlePixelPlus.getVarOrDefault(
							"robot_wave_timer",
							0,
							"int"
						);
			...
			const addPurpleKeyNotifications = () => {
				var purpleKeyUnlocked = IdlePixelPlus.getVarOrDefault(
					"guardian_purple_key_hint",
					0,
					"int"
				);
				...
				elemKey.setAttribute(
					"src",
					"https://d1xsc8x7nc5q8t.cloudfront.net/images/purple_gaurdian_key.png"
				);
...
`;
			...
			menuBarCrystals.parentNode.insertBefore(
				rocketInfoSideCar,
				menuBarCrystals.nextSibling
			);
...
*/
    ...
    `;
			...
			var currentFP = IdlePixelPlus.getVarOrDefault(
				"fight_points",
				0,
				"int"
			).toLocaleString();
			var rarePotTimer = IdlePixelPlus.getVarOrDefault(
				"rare_monster_potion_timer",
				0,
				"int"
			);
			var rarePotPlusTimer = IdlePixelPlus.getVarOrDefault(
			...
			var combatLootPotActive = IdlePixelPlus.getVarOrDefault(
				"combat_loot_potion_active",
				0,
				"int"
			);
			var combatLootPotTimer = IdlePixelPlus.getVarOrDefault(
    ...
    `;
			...
			insertAfter(
				createCombatStatEntry(
					"combat-info-fight_point-right",
					"https://d1xsc8x7nc5q8t.cloudfront.net/images/fight_points.png",
			...
			insertAfter(
				createCombatStatEntry(
					...
					"https://d1xsc8x7nc5q8t.cloudfront.net/images/rare_monster_potion.png",
			...
			if (onLoginLoaded) {
				...
				if (Globals.currentPanel != "panel-combat-canvas") {
					...
					if (
						...
						const ore = IdlePixelPlus.getVarOrDefault(
							"furnace_ore_type",
							"none"
						);
						if (ore == "none") {
						...
						const timerRemaining = IdlePixelPlus.getVarOrDefault(
							"furnace_countdown",
							0,
							"int"
						);
						const timePerOre = SMELT_TIMES[ore] - 1;
						const startAmount = IdlePixelPlus.getVarOrDefault(
							"furnace_ore_amount_set",
							0,
							"int"
						);
						const doneAmount = IdlePixelPlus.getVarOrDefault(
							"furnace_ore_amount_at",
							0,
							"int"
						);
					...
					if (
						...
						document.querySelector(
							"#current-rocket-travel-distances"
						).textContent = label_side_car_dist;
						document.querySelector("#current-rocket-travel-times").textContent =
							label_side_car_eta;
						document.querySelector("#rocket-fuel-count").textContent =
							rocket_fuel;
						document.querySelector("#rocket-pot-count").textContent =
							rocket_pot_count;
					...
					const rocketStatus = IdlePixelPlus.getVarOrDefault(
						"rocket_status",
						""
					);
					const rocketImage = document.querySelector(
						"img#notification-rocket-image"
					);
					...
					const menuBarRocketMoon = document.querySelector(
						"#menu-bar-rocket_moon"
					);
					const menuBarRocketSun = document.querySelector(
						"#menu-bar-rocket_sun"
					);
					const rocketTypeImgReg = document.querySelector(
						"img#rocket-type-img-reg"
					);
					...
					if (
						this.getConfig("leftSideRocketInfoSection") &&
						rocket_usable > 0
					) {
						...
						if (this.getConfig("leftSideRocketInfo")) {
							...
							showBlockElement(
								document.getElementById("notification-mega_rocket")
							);
							hideElement(document.getElementById("rocket-travel-info"));
						} else if (rocket_travel_check > 0 && rocket_check == 0) {
							showInlineBlockElement(
								document.getElementById("notification-rocket")
							);
							hideElement(document.getElementById("rocket-travel-info"));
						} else {
							hideElement(document.getElementById("rocket-travel-info"));
						...
						if (this.getConfig("leftSideRocketFuel")) {
							showBlockElement(
								document.getElementById("current-rocket-fuel-info")
							);
						} else {
						...
						if (this.getConfig("leftSideRocketPot")) {
							showBlockElement(
								document.getElementById("current-rocket-pot-info")
							);
							hideElement(
								document.getElementById(
									"notification-potion-rocket_potion_timer"
					...
					const sdWatchCharges = IdlePixelPlus.getVarOrDefault(
						"stardust_watch_charges",
						0,
						"int"
					);
					...
					if (key.startsWith("gathering_working_gathering_loot_bag_")) {
						...
						var bagCount = IdlePixelPlus.getVarOrDefault(
							key,
							0,
							"int"
						).toLocaleString();
					...
					const submarine_boat_timer = IdlePixelPlus.getVarOrDefault(
						"submarine_boat_timer",
						0,
						"int"
					);
					if (hideBoatNotifications) {
					...
					if (key === "furnace_ore_amount_set") {
						setTimeout(function () {
							var furnaceOreTypeVar = IdlePixelPlus.getVarOrDefault(
								"furnace_ore_amount_set",
								0,
								"int"
							);
					...
					if (key.startsWith("nades_purple_key")) {
						let purpKeyMonst = IdlePixelPlus.getVarOrDefault(
							"nades_purple_key_monster",
							"",
							"string"
						);
						let purpKeyRarity = IdlePixelPlus.getVarOrDefault(
							"nades_purple_key_rarity",
							"",
							"string"
						);
						let purpKeyTimer = IdlePixelPlus.getVarOrDefault(
							"nades_purple_key_timer",
							0,
							"int"
						);
