...
(function () {
  ...
  <span onClick="websocket.send(Modals.clicks_rocket())" id="menu-bar-rocket_moon">
    ...
    <img id="moon-rocket-img" class="img-20" src="${UIT_IMAGE_URL_BASE}rocket.png">
    <img id="moon-mega-rocket-img" class="img-20" src="${UIT_IMAGE_URL_BASE}mega_rocket.gif">
  ...
  <span onClick="websocket.send(Modals.clicks_rocket())" id="menu-bar-rocket_sun">
    ...
    <img id="sun-rocket-img" class="img-20" src="${UIT_IMAGE_URL_BASE}mega_rocket.gif">
...
`;
  ...
  <div id="rocket-travel-info">
    ...
    <br/>
    <img id="rocket-type-img-mega" class="img-20" src="${UIT_IMAGE_URL_BASE}mega_rocket.gif">
    <img id="rocket-type-img-reg" class="img-20" src="${UIT_IMAGE_URL_BASE}rocket.gif">
        ...
        onVariableSet(key, valueBefore, valueAfter) {
            if (onLoginLoaded) {
                ...
                if (Globals.currentPanel != "panel-combat-canvas") {
                    ...
                    const rocket_pot_timer_check = getVar(
                        "rocket_potion_timer",
                        0,
                        "int"
                    );
                    ...
                    if (key.startsWith("nades_purple_key")) {
                        ...
                        uitPurpleKey().onPurpleKey(purpKeyMonst, purpKeyRarity, purpKeyTimer);
                    }
